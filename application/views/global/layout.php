...
<body>
    ...
    <nav class="teal darken-2">
      <div class="container">
        ...
        <div class="nav-wrapper">
          <a href="<?php echo base_url(); ?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/LogoSd.png" width="45px" alt=""></a>
  ...
  <ul class="sidenav" id="mobile-nav">
    ...
    <li><a class="btn btn-success" href="<?php echo base_url(); ?>/web/log">MASUK</a></li>
  </ul>
  <!-- SideNav-end -->
  <!-- Slider -->
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img" width="200px" src="<?php echo base_url(); ?>assets2/img/LogoSd.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text">PERPUSTAKAAN </h3>
        <h2 class="header center white-text">SD MUHAMMADIYAH BLAWONG 1</h2>


      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/sdmuhblawong1.jpeg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
